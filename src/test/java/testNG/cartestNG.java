...
public class cartestNG {
	...
	@Test(priority=4,dependsOnMethods= {"user_clicks_on_buying_a_new_car_option"})
	...
	@Test(priority=5,dependsOnMethods= {"user_clicks_on_buying_a_new_car_option"})
	...
	@Test(priority=6,dependsOnMethods= {"user_clicks_on_buying_a_new_car_option"})
	...
	@Test(priority=7,dependsOnMethods= {"user_clicks_on_buying_a_new_car_option"})
	...
	@Test(priority=8,dependsOnMethods= {"user_clicks_on_buying_a_new_car_option"})
